...
5. If the code uses **undefined variable names that clearly mismatch the parameters**, **DO NOT rename them**. Instead, add an inline comment `# TODO: Variable 'X' is not defined. Did you mean 'Y'?` **on the line after the undefined variable usage**.
